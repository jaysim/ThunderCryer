    ...
    switch ((TargetInterface.peekWord(0xE0042000) & 0xfff))
      {
        ...
        case 0x413: // STM32F40x/STM32F41x
          return "STM32F40x/STM32F41x";
        case 0x416: // medium density STM32L
          return "STM32L151x8/STM32L151xB/STM32L152x8/STM32L152xB";
        case 0x419: // STM32F42x/STM32F43x
          return "STM32F42x/STM32F43x";
        case 0x436: // high density STM32L
          return "STM32L151xC/STM32L151xD/STM32L152xC/STM32L152xD/STM32L162xD";
...
function MatchPartName(name)
{
  ...
  if (((CPUID>>4)&0xf)==0) // Cortex-M0
    switch ((TargetInterface.peekWord(0x40015800) & 0xfff))
      {
        case 0x440: // STM32F
          return (family=="STM32F051");
        case 0x444:
          return (family=="STM32F050");
      }
  else
    switch ((TargetInterface.peekWord(0xE0042000) & 0xfff))
      {
        ...
        case 0x416: // medium density STM32L
          return (family=="STM32L151" || family=="STM32L152") && (density=="6" || density=="8" || density=="B");
        case 0x419: // STM32F427x/STM32F437x
          return (family=="STM32F427" || family=="STM32F437") && (density=="G" || density=="I");
        case 0x436: // high density STM32L
          return (family=="STM32L151" || family=="STM32L152" || family=="STM32L162") && (density=="C" || density=="D");
        case 0x422: // STM32F30x
