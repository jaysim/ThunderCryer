...
public:
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void Line(unsigned int x1, unsigned int y1,unsigned int x2, unsigned int y2) = 0;
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void Window(unsigned int x,unsigned int y,unsigned int width,unsigned int height) = 0;
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void Rectangle(unsigned int x,unsigned int y,unsigned int width,unsigned int height, bool fill) = 0;
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void SectorClear(unsigned int x,unsigned int y,unsigned int width,unsigned int height) = 0;
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void Circle(unsigned char cx, unsigned char cy ,unsigned char radius) = 0;
	...
	/**
	  ...
	  * @retval None
	  */
	virtual void Bitmap(unsigned char * bitmap, unsigned char x, unsigned char y, unsigned char width, unsigned char height) = 0;
